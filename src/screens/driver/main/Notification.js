  ...
  const notificationData = [
    {
      ...
      discription: 'Fear leads to anger … anger leads to hate hate leads to suffering.',
      status: 'Reached'
    },
    {
      id: '2',
      title: 'Booking Accepted',
      discription: 'Qrygg elomin kashyyyk skirata. Oswaft mirta omwati kohl shmi.',
      status: 'Accepted'
    ...
    },
    {
      ...
      discription: 'You would destroy the Sith, not join them! Bring balance to the force...',
      status: 'Cancelled'
                ...
                return (
                  <View style={styles.noficationView}>
                    ...
                    <View style={{ marginHorizontal: wp(9) }}>
                      <Text numberOfLines={3} style={styles.notiTExt}>{item.message}</Text>
                    </View>
                    <TouchableOpacity
