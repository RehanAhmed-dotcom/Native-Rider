...
const PaymentCompleteRide = ({navigation,route}) => {
  ...
  return (
    <ImageBackground source={images.paybackground} resizeMode='cover' style={[styles.mainContainer,
        { paddingTop: Platform.OS == 'ios' ? top : 0 }]}>
            <Header head="Successful" onPress={() => navigation.navigate('Drawer')} />
            <ScrollView>
                <View style={{ alignSelf: 'center', marginTop: wp(15), marginHorizontal: wp(20) }}>
                    ...
                    <Text style={[styles.paymentStyle, { fontSize: 18, textAlign: 'center' }]}>Rs {response?.amount}</Text>
                </View>
...
export default PaymentCompleteRide