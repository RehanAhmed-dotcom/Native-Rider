...
const Subscription = ({navigation}) => {
  ...
  console.log('user data sub',user)
        ...
        PostAPiwithToken({ url: 'edit', Token: token }, formdata)
            .then(res => {
                ...
                if (res?.status === 'success') {
                    ...
                    const errorMessage = res?.message?.email || res?.message || 'An error occurred.';
                    Toast.show({
                        type: 'error',
                        text1: 'Error',
                        text2: errorMessage,
       ...
       <Modal
              ...
              <View
                ...
                <View
                  ...
                  <View>
                    <Image source={require('../../../assets/unsubscribe.png')} resizeMode='contain' style={{ width: wp(35), height: wp(35), alignSelf: 'center' }} />
                  </View>
                  <View style={{ alignSelf: 'center', marginHorizontal: wp(17), marginTop: wp(5) }}>
                    <Text
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginHorizontal: wp(7), marginTop: wp(5) }}>
                    <TouchableOpacity onPress={() => {_cancelSubscriptionApi() , closemodalSout() }} style={styles.modalbutton1}>
                      <Text style={[styles.titleText, { fontSize: 14 }]}>Yes</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => closemodalSout()} style={styles.modalbutton2}>
            ...
            <Modal
              ...
              <View
                style={styles.modalTopView}>
                <View
                  style={[styles.modalsecondView,{paddingTop:wp(5)}]}>
                    <TouchableOpacity onPress={()=>closeFreeTrail()} style={{position:'absolute',top:wp(3),right:wp(3),width:wp(8),height:wp(8),justifyContent:'center',alignItems:'flex-end'}}>
                    <AntDesign name={'close'} size={20} color={'black'} />
                    </TouchableOpacity>
                 <Text style={{fontSize:18,fontFamily:fonts.bold,color:Colors.black,textAlign:'center'}}>Subscription</Text>
                  <View>
                    <Image source={require('../../../assets/trailpic.png')} resizeMode='cover' style={{ width: wp(75), height: wp(40), alignSelf: 'center' }} />
                  </View>
                  <View style={{ alignSelf: 'center', marginHorizontal: wp(5), marginTop: wp(5) }}>
                    <Text
                      style={[styles.modalText,{fontFamily:fonts.medium}]}>
                      After 5 days trial, you’ll need to update 
                      to monthly subscription
                    </Text>
                  </View>
                    <TouchableOpacity onPress={() => {closeFreeTrail() }} style={{    width: wp(80), height: wp(12), backgroundColor: Colors.buttoncolor, borderRadius: wp(3), justifyContent: 'center', alignItems: 'center',alignSelf:'center',marginTop:wp(6)}}>
