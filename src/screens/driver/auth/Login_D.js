...
const Login_D = ({navigation}) => {
  const {
    driverCredentials: {email: savedEmail, password: savedPassword, rememberMe},
      ...
      .then(res => {
        ...
        if (res.status === 'success') {
          ...
          if (check && !isFacebookLogin) {
            dispatch(
              setDriverCredentials({email, password, rememberMe: check}),
            );
          } else {
          ...
          navigation.navigate('AccountVerifyOtp_D', { user_res: email });
          Toast.show({
            type: 'success',
            text1: 'Success',
            text2: 'Your account is not verified. Please verify your account to continue.',
            topOffset: Platform.OS === 'ios' ? 20 : 0,
            visibilityTime: 3000,
            autoHide: true,
          });
                ...
                <ScrollView
                  ...
                  <View style={styles.checkrow}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => navigation.navigate('Forget_D')}>
                      <Text
                        style={[
                          styles.textStyle,
                          {
