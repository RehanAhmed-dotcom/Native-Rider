...
const Conversation_R = ({navigation, route}) => {
  ...
  const guestData = {
    username:
      dataToUse?.name || item2?.user?.username || item2?.driver?.username,
      ...
      <KeyboardAvoidingView
        ...
        <View
          style={{
            ...
            position: 'absolute',
            bottom: Platform.OS === 'ios' && isKeyboardVisible ? wp(75) : wp(5),
            alignSelf: 'center',
            width: wp(90),
          ...
          <TextInput
            style={[styles.inputtext, {height: wp(13)}]}
