...
const SharedResDetails_R = ({navigation,route}) => {
 ...
 const MakeOffer = () => {
    ...
    formdata.append('participant_id', item.id);
          formdata.append('driver_offered_price', offeringprice);
    formdata.append('status', 'counter');
    setIsLoading(true);
  ...
  return (
      <View
        ...
        <View style={[styles.HeaderView]}>
          ...
          <Text style={styles.headerText}>Shared Reservation Detail</Text>
          <TouchableOpacity
            onPress={() =>
            ...
            <View
              ...
              <View>
                ...
                <Text
                  ...
                  {item?.reservation?.scheduled_time}
                </Text>
              </View>
              <View>
                <Text
                ...
                <Text
                  ...
                  {item?.reservation?.scheduled_date}
                </Text>
              </View>
            </View>
          </View>
          {item.status == 'pending' ? (
            ...
            <View
              ...
              {isToday ? (
                <TouchableOpacity
                  onPress={() =>
                    navigation.navigate('TrackReservationMap_R', {item, distance})
                  }
                  style={{
                    width: wp(90),
                    height: wp(13),
...
export default SharedResDetails_R