...
const Onboarding3_R = ({navigation}) => {
      ...
      <View
        ...
        <View
          ...
          <Text
            ...
            Make Event Travel Hassle-Free
          </Text>
          <Text style={styles.onboardTextP}>
            Organize group trips with custom access codes for your attendees.
            Keep everyone on time and connected from start to finish.
          </Text>
        </View>
        <TouchableOpacity
          activeOpacity={0.6}
          onPress={() => navigation.navigate('Onboarding4_R')}>
          <Image
